...
osc(i, amp, a,d,s,r, f, rez) = bLimit(_ * i, 18,000) : ((os.osc*0.5) * amp) * en.adsre(a,d,s,r,gate) : filtBP
with{
...
theTab(i,sel) = it.interpolate_cubic(sel*3, rdtable(wave1,i), rdtable(wave2,i), rdtable(wave3,i),rdtable(wave4,i) );
